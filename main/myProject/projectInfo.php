...
?>
<div class="bar-area">
  <img id="projectInfo-bar-img" src="/images/main/background/bar-projectInfo.png"></img>
</div>
<?PHP
...
<div class="row pi-1st">
  <div class="col-md-6">
    <div class="pi-title-banner">
      <img id="cd-img-bg" class="cd-img-bg" src="/images/main/background/pi-cd.png">
    ...
    <div class="row pi-main-row-top album-info-area">
      ...
      <div class="col-xs-7 pi-main-formgroup">
        <div class="form-group">
          ...
          <div class=\"col-xs-2\"><img id=\"project-edit-btn\" onclick=\"project_edit_mode($pro_dbid);\" class=\"projectinfo-edit-btn\" src=\"/images/main/button/user-edit-btn.png\"></div>     
          ");
          }
          else{
            echo("
  ...
  <div class="col-md-6">
    <div class="pi-ra-banner">
      <img class="related-albums-img" src="/images/main/background/pi-relatedAlbums.png">
    </div>

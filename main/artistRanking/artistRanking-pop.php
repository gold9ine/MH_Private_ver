...
<table class="table table-hover">
  <tr class="rank-area-row">
    ...
    <td class="rank-td2"><?php echo("<img onclick=\"getAlbumInfo($pop_pro_dbid[$i]);\" class=\"rank-projcet-img\" src=\"/uploads/albumImg/$pop_pro_dbALBUM_IMAGE_PATH[$i]\"/>");?></td>
    <td>
      <?php echo("
      <a type=\"button\" onclick=\"session_play_add($pop_pro_dbid[$i], '$pop_pro_dbTITLE[$i]', '$pop_pro_dbARTIST[$i]', '$pop_pro_dbSOUND_PATH[$i]')\" class=\"rank-button rank-play-add-button\"></a>
      <a href=\"/uploads/music/$pop_pro_dbSOUND_PATH[$i]\" download=\"$pop_pro_dbSOUND_PATH[$i]\" type=\"button\" class=\"rank-button rank-download-button\"></a>
      <a type=\"button\" onclick=\"like_project($pop_pro_dbid[$i])\" class=\"rank-button rank-like-button\"></a>
      "); ?>
      <br>
      <div class="rank-title"><h3><?php echo("$pop_pro_dbTITLE[$i] - $pop_pro_dbARTIST[$i]"); ?></h3></div>
      <div class="rank-info"><h4><?php echo("$pop_pro_dbSOUND_PATH[$i]"); ?></h4></div>
      <div class="rank-info"><h3><?php echo("$pop_pro_dbPROJECT_INFO[$i]"); ?></h3></div>
    </td>
    <?php
    $temp_pro_dbid=$pop_pro_dbpri_user_id[$i];

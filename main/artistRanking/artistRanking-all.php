...
<table class="table table-hover">
  <tr class="rank-area-row">
    ...
    <?php
    $temp_pro_dbid=$all_pro_dbpri_user_id[$i];
  ...
  <?php $i++; ?>
    ...
    <tr class="rank-area-row">
    <td class="rank-td1" style="padding-left: 0; padding-right: 0;"><div class="rank-6"></div></td>
    <td class="rank-td2"><?php echo("<img onclick=\"getAlbumInfo($all_pro_dbid[$i]);\" class=\"rank-projcet-img\" src=\"/uploads/albumImg/$all_pro_dbALBUM_IMAGE_PATH[$i]\"/>");?></td>
    <td>
      <?php echo("
      <a type=\"button\" onclick=\"session_play_add($all_pro_dbid[$i], '$all_pro_dbTITLE[$i]', '$all_pro_dbARTIST[$i]', '$all_pro_dbSOUND_PATH[$i]')\" class=\"rank-button rank-play-add-button\"></a>
  ...
  <?php $i++; ?>
    ...
    <tr class="rank-area-row">
    <td class="rank-td1" style="padding-left: 0; padding-right: 0;"><div class="rank-7"></div></td>
    <td class="rank-td2"><?php echo("<img onclick=\"getAlbumInfo($all_pro_dbid[$i]);\" class=\"rank-projcet-img\" src=\"/uploads/albumImg/$all_pro_dbALBUM_IMAGE_PATH[$i]\"/>");?></td>
    <td>
      <?php echo("
      <a type=\"button\" onclick=\"session_play_add($all_pro_dbid[$i], '$all_pro_dbTITLE[$i]', '$all_pro_dbARTIST[$i]', '$all_pro_dbSOUND_PATH[$i]')\" class=\"rank-button rank-play-add-button\"></a>
  ...
  <?php $i++; ?>
    ...
    <tr class="rank-area-row">
    <td class="rank-td1" style="padding-left: 0; padding-right: 0;"><div class="rank-8"></div></td>
    <td class="rank-td2"><?php echo("<img onclick=\"getAlbumInfo($all_pro_dbid[$i]);\" class=\"rank-projcet-img\" src=\"/uploads/albumImg/$all_pro_dbALBUM_IMAGE_PATH[$i]\"/>");?></td>
    <td>
      <?php echo("
      <a type=\"button\" onclick=\"session_play_add($all_pro_dbid[$i], '$all_pro_dbTITLE[$i]', '$all_pro_dbARTIST[$i]', '$all_pro_dbSOUND_PATH[$i]')\" class=\"rank-button rank-play-add-button\"></a>
  ...
  <?php $i++; ?>
    ...
    <tr class="rank-area-row">
    <td class="rank-td1" style="padding-left: 0; padding-right: 0;"><div class="rank-9"></div></td>
    <td class="rank-td2"><?php echo("<img onclick=\"getAlbumInfo($all_pro_dbid[$i]);\" class=\"rank-projcet-img\" src=\"/uploads/albumImg/$all_pro_dbALBUM_IMAGE_PATH[$i]\"/>");?></td>
    <td>
      <?php echo("
      <a type=\"button\" onclick=\"session_play_add($all_pro_dbid[$i], '$all_pro_dbTITLE[$i]', '$all_pro_dbARTIST[$i]', '$all_pro_dbSOUND_PATH[$i]')\" class=\"rank-button rank-play-add-button\"></a>
  ...
  <?php $i++; ?>
    ...
    <tr class="rank-area-row">
    <td class="rank-td1" style="padding-left: 0; padding-right: 0;"><div class="rank-10"></div></td>
    <td class="rank-td2"><?php echo("<img onclick=\"getAlbumInfo($all_pro_dbid[$i]);\" class=\"rank-projcet-img\" src=\"/uploads/albumImg/$all_pro_dbALBUM_IMAGE_PATH[$i]\"/>");?></td>
    <td>
      <?php echo("
      <a type=\"button\" onclick=\"session_play_add($all_pro_dbid[$i], '$all_pro_dbTITLE[$i]', '$all_pro_dbARTIST[$i]', '$all_pro_dbSOUND_PATH[$i]')\" class=\"rank-button rank-play-add-button\"></a>
